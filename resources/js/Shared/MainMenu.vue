<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/daily-report/add">
        <icon name="office" class="mr-2 w-4 h-4" :class="isUrl('daily-report/add') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
